...
BOOST_AUTO_TEST_CASE(prefix_chain_two_nodes) try {
    ...
    prefix_tree tree(root);
    tree.insert(chain, get_pub_key(), 0);
    tree.insert(chain, get_pub_key(), 0);
